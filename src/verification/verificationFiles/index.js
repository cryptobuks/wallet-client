...
export {
  default as DrivingLicenseVerification,
} from './license/DrivingLicenseVerification';
export {
  default as PassportVerification,
} from './passport/PassportVerification';
export { default as SelfieVerification } from './selfie/SelfieVerification';
export { ChooseDocumentType } from './choose/ChooseDocumentType';
